...
Implement the changes to the spec made in the latest Git commits, making use of the knowledge in @docs/impls/svelte.md that refers to the state of the current implementation.

1. Run the command `git diff main` to see proposed changes to the spec
2. Run the command `zamm impl create --spec <spec ID> --for docs/impls/svelte.md` to create a new implementation plan file
