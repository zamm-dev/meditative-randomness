...
Each implementation of Meditative Randomness will have the following common operations defined for the given stack:

- A command to format all the code
- A command to lint the code
- A command to run all tests
- A command to run a live debuggable version of the website
- A command to build a static deployable version of the website
